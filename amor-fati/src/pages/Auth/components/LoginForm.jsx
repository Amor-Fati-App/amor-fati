  ...
  return (
    <>
      <div className="mb-8">
        ...
        >
          Enter the void to resume your journey.
        </p>
      </div>
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              id="remember"
              className="accent-gold w-3 h-3 bg-white/10 border-white/20 rounded cursor-pointer"
            />
            <label
              htmlFor="remember"
              className="font-sans text-[10px] text-white/50 uppercase tracking-wide cursor-pointer select-none"
            >
              Remember Me
            </label>
          </div>
          <a
            href="#"
            id="forgot-link"
            className="font-sans text-[10px] text-gold/80 hover:text-white uppercase tracking-wide transition-colors"
            rel="nofollow"
          >
            Forgot Password?
          </a>
